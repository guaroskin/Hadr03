...
class Run : public G4Run
{
  ...
  private:
    ...
    G4int Ineutron;   
    G4int Tneutron;      //Numero de neutrones que salen del tanque
    G4int Tgamma;      //Numero de gammas que salen del tanque
    G4int Igamma;      //Numero de gammas que entran del tanque
