...
LAGO_G4_SteppingAction::LAGO_G4_SteppingAction(LAGO_G4_RecorderBase* r, LAGO_G4_HistoManager* HistoMan)
...
LAGO_G4_SteppingAction::~LAGO_G4_SteppingAction() {}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void LAGO_G4_SteppingAction::UserSteppingAction(const G4Step * theStep){

  G4Track* theTrack = theStep->GetTrack();

  if ( theTrack->GetCurrentStepNumber() == 1 ) fExpectedNextStatus = Undefined;
 
  LAGO_G4_UserTrackInformation* trackInformation
    =(LAGO_G4_UserTrackInformation*)theTrack->GetUserInformation();
  ...
  if(theTrack->GetParentID()==0){
    ...
    if(fOneStepPrimaries&&thePrePV->GetName()=="wcd") 
  ...
  if(particleType==G4OpticalPhoton::OpticalPhotonDefinition()){
   ...
   //theTrack->SetTrackStatus(fStopAndKill);
    ...
    if(thePostPoint->GetStepStatus()==fGeomBoundary){
      if(fExpectedNextStatus==StepTooSmall){
        if(boundaryStatus!=StepTooSmall){
          ...
          ed << "LAGO_G4_SteppingAction::UserSteppingAction(): "
                << "No reallocation step after reflection!"
                << G4endl;
          G4Exception("LAGO_G4_SteppingAction::UserSteppingAction()", "LAGO_G4_Expl01",
          FatalException,ed,
      ...
      case Detection: //Note, this assumes that the volume causing detection
        ...
        G4String sdName="/LAGO_G4_Det/pmtSD";
        LAGO_G4_PMTSD* pmtSD = (LAGO_G4_PMTSD*)SDman->FindSensitiveDetector(sdName);
	...
	G4double time=theStep->GetPostStepPoint()->GetGlobalTime();
        ...
        fHistoMan->fill(pmtNumber, ener, time);
