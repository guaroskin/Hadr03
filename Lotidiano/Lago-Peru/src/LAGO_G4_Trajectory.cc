...
G4ThreadLocal G4Allocator<LAGO_G4_Trajectory>* LAGO_G4_TrajectoryAllocator = 0;
...
//LAGO_G4_Trajectory::LAGO_G4_Trajectory(const G4Track* aTrack)
...
//LAGO_G4_Trajectory::LAGO_G4_Trajectory(LAGO_G4_Trajectory &right)
...
void LAGO_G4_Trajectory::DrawTrajectory() const
{
