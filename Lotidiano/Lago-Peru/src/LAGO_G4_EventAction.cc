...
/*LAGO_G4_EventAction::LAGO_G4_EventAction(LAGO_G4_RecorderBase* r)
...
{
  fEventMessenger = new LAGO_G4_EventMessenger(this);
}*/
LAGO_G4_EventAction::LAGO_G4_EventAction(LAGO_G4_RecorderBase* r)
  :  fRecorder(r),fSaveThreshold(0),fPMTCollID(-1),fPMTThreshold(1)
...
LAGO_G4_EventAction::~LAGO_G4_EventAction(){}

//....oooOO0OOooo........oooOO0OOooo........oooOO0OOooo........oooOO0OOooo......

void LAGO_G4_EventAction::BeginOfEventAction(const G4Event* anEvent){
 
  //New event, add the user information object
  G4EventManager::
    GetEventManager()->SetUserInformation(new LAGO_G4_UserEventInformation);
...
void LAGO_G4_EventAction::EndOfEventAction(const G4Event* anEvent){

  LAGO_G4_UserEventInformation* eventInformation
    =(LAGO_G4_UserEventInformation*)anEvent->GetUserInformation();
  ...
  if (G4VVisManager::GetConcreteInstance()){
    for (G4int i=0; i<n_trajectories; i++){
      LAGO_G4_Trajectory* trj = (LAGO_G4_Trajectory*)
  ...
  //LAGO_G4_ScintHitsCollection* scintHC = 0;
  LAGO_G4_PMTHitsCollection* pmtHC = 0;
  G4HCofThisEvent* hitsCE = anEvent->GetHCofThisEvent();
 
  //Get the hit collections
  if(hitsCE){
  //  if(fScintCollID>=0)scintHC = (LAGO_G4_ScintHitsCollection*)(hitsCE->GetHC(fScintCollID));
    if(fPMTCollID>=0)pmtHC = (LAGO_G4_PMTHitsCollection*)(hitsCE->GetHC(fPMTCollID));
  }
...
*/
  /*  if(eventInformation->GetEDep()==0.){
      ...
      if(fVerbose>0){
        G4cout << "\tEnergy weighted position of hits in LAGO_G4_ : "
 ...
 */
  ...
  if(pmtHC){
    ...
    if(eventInformation->GetHitCount()>0){//dont bother unless there were hits
      ...
      /*if(fVerbose>0){
        G4cout << "\tReconstructed position of hits in LAGO_G4_ : "
               << reconPos/mm << G4endl;
      }*/
...
void LAGO_G4_EventAction::SetSaveThreshold(G4int save){
