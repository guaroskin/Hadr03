...
#ifndef LAGO_G4_UserEventInformation_h
#define LAGO_G4_UserEventInformation_h 1

class LAGO_G4_UserEventInformation : public G4VUserEventInformation
{
  public:

    LAGO_G4_UserEventInformation();
    virtual ~LAGO_G4_UserEventInformation();
